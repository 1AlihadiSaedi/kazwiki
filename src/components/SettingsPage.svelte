  ...
  <div class="settings-header">
    ...
    {#if user}
      <span class="user-badge">
        <span class="user-email">{user.displayName || user.username || ''}</span>
  ...
  {:else if myProfile}
    <div class="profile-card">
      <div class="profile-row">
        <span class="profile-label">{t(lang, 'username')}</span>
        <span class="profile-value" dir="ltr">{myProfile.username || user?.username}</span>
      </div>
      <div class="profile-row">
        <span class="profile-label">{t(lang, 'displayName')}</span>
        <span class="profile-value">{myProfile.display_name || user?.displayName || '-'}</span>
      </div>
      <div class="profile-row">
        <span class="profile-label">{t(lang, 'role')}</span>
        <span class="profile-value role-badge role-admin">admin</span>
      </div>
    </div>
  {:else}
